...
- **🚫** Not a general `get_snapshot` / CaptureEngine product API (that stays out of scope).
...
- **💩** CF `main_document_response` — defer after Phase 3 **✅**
...
- **✔️** **🔷** Cookie / `NetworkSession` surface for Snappr-style `site_cookies` (get/add)
- **⏳** **💩** Full settle / CF `main_document_response` for Snappr-style `Browser`
- **⏳** **🔷** **Downloads** — requirements + API lock: **[`1.1-downloads.md`](1.1-downloads.md)** (consumer: OLLMchat **[`5.0.5`](file:///home/alan/gitlive/OLLMchat/docs/plans/5.0.5-webkit-download.md)** ✔️ Linux / **5.0.2** Android). **🚫** Not Phase 3; **🚫** no download-manager UI here
