...
- ℹ️ Consumer: `/home/alan/gitlive/OLLMchat` — `libocwebkit` browser tool; Android track [`5.0.2-DONE-android-webkit-control.md`](file:///home/alan/gitlive/OLLMchat/docs/plans/done/5.0.2-DONE-android-webkit-control.md)
- ℹ️ Parent tool contract: OLLMchat [`5.0-webkit-control.md`](file:///home/alan/gitlive/OLLMchat/docs/plans/5.0-webkit-control.md) (a11y markdown, fill/press — **not** DOM/JS scrape)
- ℹ️ HTML form attrs for fill keys: [`1.3-a11y-html-name-attribute.md`](1.3-a11y-html-name-attribute.md) (OLLMchat **5.0.8**)
...
- **🔷** `network_session` `{ get; construct; }` → cookie manager (`get_cookies` / `add_cookie` async, accept policy) — enough for OLLMchat-style `site_cookies`
